    ...
    return (
      <div className="dish-popup">
        ...
        <ul className="one-line">
          <li>Вес: <strong>{dish.weight}</strong> г</li>
          <li>Каллорийность: <strong>{dish.kcal}</strong> ккал</li>
          <li>Белки: <strong>{dish.carbos}</strong> г</li>
          <li>Жиры: <strong>{dish.fats}</strong> г</li>
          <li>Углеводы: <strong>{dish.carbos}</strong></li>
        </ul>
